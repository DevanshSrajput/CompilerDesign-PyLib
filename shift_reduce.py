...
def shift_reduce_parse(productions: list, tokens: list) -> dict:
    ...
    productions: list of (lhs, rhs) tuples, rhs is a list of symbols
    tokens: list of input terminal strings

    Returns:
        {
          'accepted': bool,
          'steps': list of step dicts {stack, input, action},
          'error': str or None
        }
    """
