...
Supports standard arithmetic/logical expressions using:
  - Operators: + - * / % ^ ( )
  - Operands: single characters or multi-character tokens separated by spaces
"""
...
def _tokenize(expr: str) -> list:
    """Tokenize an infix expression string into a list of tokens."""
    tokens = []
    i = 0
    expr = expr.strip()
    while i < len(expr):
